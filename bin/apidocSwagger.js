...
var argv = nomnom
    ...
    .option("parse-filters", {
        help: "Optional user defined filters. Format name=filename"
    })
    .option("parse-languages", {
        help: "Optional user defined languages. Format name=filename"
    })
    .option("parse-parsers", {
        help: "Optional user defined parsers. Format name=filename"
    })
    .option("parse-workers", {
        help: "Optional user defined workers. Format name=filename"
    })
